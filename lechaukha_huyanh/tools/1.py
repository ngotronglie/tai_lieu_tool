...
print(Colorate.Diagonal(Colors.green_to_white, '     ╚══════════════════════════════════════════════════════════════╝'))
print(Colorate.Diagonal(Colors.red_to_white, '             TOOL LỌC LIVE/DIE NẾU CÓ VẤN ĐỀ HÃY LIÊN HỆ ADMIN'))
print(Colorate.Diagonal(Colors.green_to_white, '════════════════════════════════════════════════════════════════════════'))
while True:
    try:
...
print(Colorate.Diagonal(Colors.red_to_white, '             TOOL LỌC LIVE/DIE NẾU CÓ VẤN ĐỀ HÃY LIÊN HỆ ADMIN'))
print(Colorate.Diagonal(Colors.green_to_white, '════════════════════════════════════════════════════════════════════════'))
print(Colorate.Diagonal(Colors.green_to_white, '+-+-+-+-+-+-+-+-ĐÃ LỌC XONG CẢM ƠN BẠN ĐÃ SỬ DỤNG TOOL+-+-+-+-+-+-+-+-+-'))
print(Colorate.Diagonal(Colors.green_to_white, '════════════════════════════════════════════════════════════════════════'))
