...
class SPAM:
    ...
    def banner(self):
    #os.system("cls" if os.name == "nt" else "clear")
        title = '\n\n\n \033[1;93mTOOL SPAM SMS BẢN THƯỜNG. '
 ...
 |__   __|  / __ \   / __ \  | |     
    ...
    def run(self):
        while True:
            self.banner()
            self.phone = input(self.format_input("!",f"\033[1;31mNHẬP SĐT SPAM: \n"))
            if self.phone != '0834617174':
                if len(self.phone) == 10:
                    break
                print(self.format_print("!", "SỐ ĐIỆN THOẠI DƯỚI <10 SỐ XIN NHẬP LẠI !"))
            if self.phone == '0834617174':
               print(self.format_print("!", "\033[1;37mCĐMM THẰNG MẤT DẠY MÀY ĐỊNH SPAM TAO À THICK THÌ GỌI THẲNG CHO TAO \033[1;32m0834617174 \033[1;37mOK Z NHA THẰNG CHÓ"))
            time.sleep(8)
