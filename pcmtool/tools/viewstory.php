...
def ndp_delay(o):
    while(o>1):
        o=o-1
        print(f'\033[1;31m[\033[1;33mPCM\033[1;31m][\033[1;32m|\033[1;31m][\033[1;35mL\033[1;36mO......\033[1;31m][\033[1;37m{o}\033[1;31m]','     ',end='\r');sleep(1/6)
        print(f'[PCM][\033[1;35m/\033[1;31m][LOA.....][{o}]','     ',end='\r');sleep(1/6)
        print(f'\033[1;31m[\033[1;33mPCM\033[1;31m][\033[1;37m-\033[1;31m][\033[1;32mL\033[1;35mO\033[1;34mA\033[1;33mD....\033[1;31m][\033[1;36m{o}\033[1;31m ]','     ',end='\r');sleep(1/6)
        print(f'[PCM][\033[1;34m+\033[1;31m][LOADI...][{o}]','     ',end='\r');sleep(1/6)
        print(f'\033[1;31m[\033[1;33mPCM\033[1;31m][\033[1;33m\\033[1;31m][\033[1;35mL\033[1;36mO\033[1;35mA\033[1;32mD\033[1;36mI\033[1;37mN..\033[1;31m][\033[1;35m{o}\033[1;31m]','     ',end='\r');sleep(1/6)
        print(f'[PCM][\033[1;33m|\033[1;31m][LOADING.][{o}]','     ',end='\r');sleep(1/6)
...
clear()
banner()
cookie = input(ndp_tool+luc+'Nhập Cookie Facebook Chứa Page Pro5'+trang+': '+vang)
headers = {
...
try:
    ...
    exit(ndp_tool+do+"Cookie Die Kiểm Tra Lại!!!")
clear()
banner()
...
thanh()
url_str = input(ndp_tool+luc+'Nhập Link Str Cần Tăng View'+trang+': '+vang)
# GET DỮ LIỆU TRONG URL
thanhphan9 = url_str.split('/')[5].split('/?')[0]
# NHẬP ĐÓ VIEW BẠN MUỐN TĂNG
thanh()
soluongview = int(input(ndp_tool+luc+'Số View Bạn Cần Tăng'+trang+': '+vang))
thanh()
delay = int(input(ndp_tool+luc+'Nhập Delay View'+trang+': '+vang))
thanh()
# RUN CODE
