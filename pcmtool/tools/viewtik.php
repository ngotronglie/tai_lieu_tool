...
banner = f"""
 ...
 |__   __|  / __ \   / __ \  | |     
    ...
    |_|     \____/   \____/  |______|
      ...
      \033[1;33mTOOL BUFF VIEW TIK TOK
\033[1;35m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
"""
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(f'{do}[{trang}PCM{do}] \033[1;36m>\033[1;31m>\033[1;37m> {do}[{xanh_la}BUFF VIEW THÀNH CÔNG{do}] {do}{xanh_duong}+: {trang}{success}{do} \033[1;36mView')
                    success += 1
                    _lock.release()
            except:
...
if __name__ == "__main__":
    ...
    print(banner)
    try:
        link = input(f'{do}[{trang}{kt_code}{do}] \033[1;36m>\033[1;31m>\033[1;37m> {xanh_la} NHẬP LINK VIDEO: {trang}')
        print(f'{do}- - - - - - - - - - - - - - - - - - - - - - - - - - - -')
        __aweme_id = str(
