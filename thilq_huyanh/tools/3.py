...
hquantool=pink+'['+blue+'THILYQUAN.XYZ'+pink+']'
hquantool_no_pro=pinkx+'[THILYQUAN.XYZ]'+end
hln=pink+"["+blue+"THILYQUAN.XYZ"+pink+"]"
sadboiz=pink+"["+blue+"THILYQUAN.XYZ"+pink+"]"
def logo():
    log="""
...
logo()
while(True):
        token_tds=input(pink+'\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mNHẬP ACCESS_TOKEN TDS: \033[1;33m')
...
while(True):
        while(True):
                while(True):
                        ck_fb=input(blue+'\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mNHẬP COOKIE FACEBOOK: \033[1;33m')
                        os.system("clear")
                        if ck_fb=='':break
        ...
        if s==stop:print(hquantool_no_pro+pink+'[SUCCESS] TỔNG XU:',yellow+str(ttacc['data']['xu'])+']')
1