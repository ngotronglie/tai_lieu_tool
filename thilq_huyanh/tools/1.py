...
def idelay(o):
    while(o>0):
        o=o-1
        print(f"[THILYQUAN.XYZ][.....""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[THILYQUAN.XYZ][•....""]""["+str(o)+"]""     ",end='\r')
        sleep(1/6)
        print(f"[THILYQUAN.XYZ][••...""]""["+str(o)+"]" "     ",end='\r')
...
tk=input('\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mNhập Tài Khoản TDS: \033[1;33m ')
mk=input('\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mNhập Mật Khẩu TDS: \033[1;33m')
data_login={
'username': tk,
'password': mk,
}
...
if "success" in log:
    print('\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mLogin Thành Công ')
    sleep(2)
else:
    print('\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;31mLogin Thất Bại ')
    exit()
sleep(0.2)
reg = log
...
xu=check_tk.json()['xu']
print('\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mXu Hiện Tại : \033[1;37m'+xu)
print('\033[1;37m- - - - - - - - - - \033[1;36mTHILYQUAN.XYZ \033[1;37m- - - - - - - - - -')
def cauhinh(idfb):
    ...
    if 'success' in run:
           print('', end='\r')
               ...
               print(run['error'])
               #quit()
cookiefb=input(f'\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mNhập Cookie Facebook: \033[1;33m')
while True:
    p+=1
    idpro5=str(input(f'\033[1;31m[\033[1;32mthilyquan.xzy \033[1;31m] \033[1;37m=> \033[1;32mNhập ID PROFILE SỐ {p}: '))
    if idpro5=='':break
    else:
        headers={
                'authority': 'www.facebook.com',
