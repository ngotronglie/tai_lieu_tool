...
def cau_hinh(id, TDS_token, name):
	...
	try: 
		...
		print(f" Cấu Hình Thành Công | ID : {id} | TÊN FACEBOOK : {name} ")
...
token = input('\033[1;35m[\033 [ZYTH]\033[1;32m Vui Lòng Nhập Token TDS : \033[1;35m ')

check_xu = login_tds(token)

cookie = input('\033[1;35m[ZYTH]\033[1;32mNhập Cookie Facebook Chứa Page: \033[1;35m ')
...
a = int(input(' \033[1;35mBạn Muốn Chạy Page Số Mấy : \033[1;33m'))

chon = a-1

print (blue + ' ⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦')

print (vang + " 1> Job Like Cảm Xúc")

print (vang + " 2> Job Tham Gia Group")

print (vang + " 3> Job Follow Tài Khoản")

print (vang + " 4> Job Tham Gia Group + Like Cảm Xúc")

print (vang + " 5> Job Tham Gia Group + Like Cảm Xúc +  Follow Tài Khoản")

chon_1 = int(input('==>  Job Muốn Chạy Là: '))

print('-'*60)

dl = int(input('Nhập Delay Giữa Các Job: '))
		...
		try :
			...
			for job_2 in a:
				...
				for i in range(dl,-1,-1):
					...
					print(f'{vang}[ZYTH] Chạy Lại Sau {i} {trang}GIÂY',end='\r')
