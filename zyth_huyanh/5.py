...
resource_dir = "/sdcard/download/zyth"
        ...
        try:
            ...
            try:
                ...
                if response.json()['status_code'] == 0:
                    ...
                    #print( 'TikTok Viewbot by HN TOOL^| success: {success} ')

                    print(Colorate.Horizontal(Colors.green_to_blue, f'[ZYTH]| Tăng thành công: {success}'))
...
def fetch_proxies():
    ...
    for url in url_list :
        ...
        if response.ok:
            ...
            with open("/sdcard/download/zyth/proxies.txt", "a+") as f:
...
if __name__ == "__main__":
    ...
    with open('/sdcard/download/zyth/devices.txt', 'r') as f:

        devices = f.read().splitlines()

    

    with open('/sdcard/download/zyth/config.json', 'r') as f:
    ...
    if config['proxy']['use-proxy']:
        ...
        with open('/sdcard/download/zyth/proxies.txt', 'r') as f:
...
\033[1;97m              ⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦⏦"""
    ...
    try:
        ...
        link = str(Write.Input("\n- Link Video Cần Tăng View > ", Colors.white_to_green, interval=0.0001))
